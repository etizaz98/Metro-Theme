window["WIDGETKIT_URL"] = "/demo/themes/wordpress/2012/subway/wp-content/plugins/widgetkit";
function wk_ajax_render_url(widgetid) {
    return"http://www.yootheme.com/demo/themes/wordpress/2012/subway/wp-admin/admin-ajax.php?action=widgetkit_render&id=" + widgetid
}
(function(f, e) {
    var a = {};
...
(function(f, e) {
    e.$widgetkit.trans = {__data: {}, addDic: function(a) {
            ...
            for (var e = 0; e < b.length; e++)
                d[e].lastIndexOf("%") == d[e].length - 1 && e != b.length - 1 && (d[e] += "s" + d.splice(e + 1, 1)[0]), c += d[e] + b[e];
            return c +
                    d[d.length - 1]
        }}
})(jQuery, window);
    ...
    f.event.special.mousewheel = {setup: function() {
            if (this.addEventListener)
                for (var b = a.length; b; )
                    this.addEventListener(a[--b], e, false);
            else
                this.onmousewheel = e
        }, teardown: function() {
            if (this.removeEventListener)
                for (var b = a.length; b; )
                    this.removeEventListener(a[--b], e, false);
            else
...
(function(d) {
    ...
    a.prototype = d.extend(a.prototype, {name: "accordion", options: {index: 0, duration: 500, easing: "easeOutQuart", animated: "slide", event: "click", collapseall: !0, matchheight: !0, toggler: ".toggler", content: ".content"}, initialize: function(a, b) {
            ...
            b.matchheight && a.find(b.content).each(function() {
    ...
    d.fn[a.prototype.name] = function() {
        ...
        return this.each(function() {
            var c = d(this);
            if (a.prototype[b] && c.data(a.prototype.name) && b != "initialize")
                c.data(a.prototype.name)[b].apply(c.data(a.prototype.name), Array.prototype.slice.call(h, 1));
    ...
    $widgetkit.lazyloaders.showcase = function(b, a) {
        ...
        c.when($widgetkit.load(WIDGETKIT_URL + "/widgets/slideset/js/slideset.js"), $widgetkit.load(WIDGETKIT_URL + "/widgets/slideshow/js/slideshow.js")).done(function() {
            ...
            d.bind("slideshow-show", function(a, b, c) {
                if (!g.removeClass("active").eq(c).addClass("active").parent().is(":visible"))
                    e[c > b ? "next" : "previous"]()
            });
            g.each(function(a) {
...
$widgetkit.load('/demo/themes/wordpress/2012/subway/wp-content/plugins/widgetkit/widgets/spotlight/js/spotlight.js').done(function() {
    jQuery(function($) {
